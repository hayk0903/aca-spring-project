...
<ul id="menu-bar">
  ...
  <c:forEach items="${productList}" var="product">
	...
	<div class="form">
		...
		<form:form id="makeorder" method="post" action="addproduct" modelAttribute="product">

			<form:label path="type">Type </form:label>
			<form:input id="type" name="type" path="type" /><br>
			<form:label path="price">Price</form:label>
			<form:input id="price" name="price" path="price" /><br>
		...
		<div class = "inf_div"> ${product_message}</div>
	</div>
